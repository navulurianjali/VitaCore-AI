  ...
  return (
    <div className="flex-1 flex flex-col bg-background pt-16">
      <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8 py-16 space-y-8">
        <h1 className="text-3xl font-bold">Terms of Service & Biomedical Disclaimer</h1>
        ...
        <div className="border-t border-foreground/5 pt-8 space-y-6 text-xs text-foreground/75 leading-relaxed font-medium">
          ...
          <h2 className="text-sm font-bold text-foreground">1. Platform Intended Purpose</h2>
          <p>
          ...
          <h2 className="text-sm font-bold text-foreground">2. Account Responsibility</h2>
          <p>
          ...
          <h2 className="text-sm font-bold text-foreground">3. Boundary Operations</h2>
          <p>
